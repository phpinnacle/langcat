...
final class ListProgramItemsRequest
{
    ...
    {
        if (!in_array($value, ['+position', '-position', '+id', '-id', '+createdAt', '-createdAt'], true)) {
            throw new InvalidArgumentException('Unsupported program item sort.');
        }
