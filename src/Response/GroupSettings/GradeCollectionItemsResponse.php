...
final readonly class GradeCollectionItemsResponse
{
    /** @param list<GradeCollectionItemResponse> $data */
    ...
    {
        return new self(
            ResponseValue::objects($payload, 'data', GradeCollectionItemResponse::fromArray(...)),
