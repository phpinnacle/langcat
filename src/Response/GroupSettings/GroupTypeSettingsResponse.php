...
final readonly class GroupTypeSettingsResponse
{
    /** @param list<GroupTypeSettingResponse> $data */
    ...
    {
        return new self(
            ResponseValue::objects($payload, 'data', GroupTypeSettingResponse::fromArray(...)),
