...
final readonly class GroupSearchResultsResponse
{
    /** @param list<GroupSearchResponse> $data */
    ...
    public static function fromArray(array $payload): self
    {
        return new self(
            array_map(
                static fn (mixed $item) => GroupSearchResponse::fromArray(
                    is_array($item) ? $item : throw new UnexpectedValueException('Each group must be an object.'),
                ),
