...
final readonly class CompaniesResponse
{
    /** @param list<CompanyResponse> $data */
    ...
    public static function fromArray(array $payload): self
    {
        return new self(
            array_map(
                static fn (mixed $item) => CompanyResponse::fromArray(
                    is_array($item) ? $item : throw new UnexpectedValueException('Each company must be an object.'),
                ),
